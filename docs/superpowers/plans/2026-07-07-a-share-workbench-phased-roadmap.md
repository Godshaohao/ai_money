...
2. V2 backend foundation: local FastAPI API, SQLite run history, and report artifact summaries.
3. V3 frontend workbench: add richer local review views without changing the P0 output contract.
